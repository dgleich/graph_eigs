      SUBROUTINE PDSYEV_TRI( JOBC, JOBZ, UPLO, N, A, IA, JA, DESCA, W,
     $                   Z, IZ, JZ, DESCZ, WORK, LWORK, JSTATE, INFO )
*
...
*
*     .. Scalar Arguments ..
      CHARACTER          JOBC, JOBZ, UPLO
      INTEGER            IA, INFO, IZ, JA, JZ, LWORK, N
*     ..
*     .. Array Arguments ..
      INTEGER            DESCA( * ), DESCZ( * ), JSTATE( * )
...
*     ..
*     .. Local Scalars ..
      LOGICAL            LOWER, WANTZ, JTRIDIA, JFULEIG
